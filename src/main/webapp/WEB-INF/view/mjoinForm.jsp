            ...
            <div class="card-body">
              <form method="post" action="/mjoin.do">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name ="adminUsertel" id="adminUsertel" placeholder="01012341234 형식으로 입력">
                  <br/>
                 <b>가입 후 최상위 관리자의 승인을 기다리셔야 합니다...</b>
                </div>
                <button onclick="checkInput()" class="btn btn-primary Btn-login">join</button>
              </form>
            </div>
          </div>
