        ...
        <main class="flex-shrink-0" id="main">
            ...
            <div class="card">
                ...
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    ...
                    <div class="h1 fw-bolder fs-5 mb-3" style="font-size:25px !important;"><%=user_nick %></div>
                    <div class="text-muted"><%=user_mail %></div>
                    <a href="/user/profile_set.do"><button type="button" class="btn btn-light rounded-pill" style="margin-top: 20px;"><b>수정</b></button>
                </div>
              </div>
              <section class="section profile">
            <!-- ======= mypage Section ======= -->
