                        ...
                        <div class="iiio-mod-display-extended iiio-animate-end" style="visibility: visible;">
                            <div class="lfBz-field-outline lfBz-mod-presentation-extended">
                                ...
                                <div role="button" tabindex="0" class="personnel NITa NITa-roomsGuests NITa-hasValue NITa-mod-presentation-expanded" aria-label="인원">
                                    ...
                                    <span class="NITa-value peopleHeadCount">인원 2명</span>
                                </div>
                        ...
                        <div class="pRB0-nav-items">
                            <nav class="HtHs" aria-label="홈">
                                <ul class="HtHs-nav-list">
                                    ...
                                    <li>
                                        <a href="/user/mypage.do" aria-label="타임머신 " class="dJtn dJtn-collapsed dJtn-mod-variant-drawer" aria-current="false" tabindex="-1">
                                            <svg viewBox="0 0 200 200" width="1.25em" height="1.25em" xmlns="http://www.w3.org/2000/svg" class="dJtn-menu-item-icon" role="img" aria-hidden="true">
                    ...
                    <div class="dDYU-body">
                        <div tabindex="-1" id="searchFormDialog" class="c1r2d c1r2d-mod-vertical-hotels c1r2d-pres-animated c1r2d-mod-primary-colors">
                            ...
                            <section class="c1r2d-form-section">
                                <form onsubmit="initializeMapByDosi(); return false;">
                                    <div class="J_T2">
                                            ...
                                            <div class="personnel J_T2-field-group J_T2-mod-collapse-l J_T2-mod-spacing-y-xxsmall">
                                                <div class="fBan">
                                                    <div class="c3JX7-wrapper">
                                                        <button role="button" onclick="headCount()" class="RxNS RxNS-mod-stretch RxNS-mod-variant-none RxNS-mod-theme-none RxNS-mod-shape-default RxNS-mod-spacing-none RxNS-mod-size-xlarge" tabindex="0" aria-disabled="false">
                                                            <div class="RxNS-button-container">
                                                                <div class="RxNS-button-content">
                                                                    <div class="c3JX7-displayContent">
                                                                        ...
                                                                        <span class="c3JX7-displayText peopleHeadCount">인원 2명</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </button>
                                        ...
                                        <div class="J_T2-footer">
                                            ...
                                            <div class="c1ClF relative">
                                                ...
                                                <div class="headCountModal" style="display: none; width: 108px; overflow-y: auto; padding: 20px; z-index: 51; position: absolute; height: 200px; top: -19px; right: 130px; border-radius: 8px; background-color: #fbfcfd; color: #444;">
                                                	<div id="count1" class="headCountOption">1 명</div>
                                                	<div id="count2" class="headCountOption">2 명</div>
                                                	<div id="count3" class="headCountOption">3 명</div>
                                                	<div id="count4" class="headCountOption">4 명</div>
                                                	<div id="count5" class="headCountOption">5 명</div>
                                                	<div id="count6" class="headCountOption">6 명</div>
                                                	<div id="countLot" class="headCountOption">단체</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
