          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="search-bar" >
                <form class="search-form" method="POST" action="/user.do">
                  <b>회원이름</b>
                  <input type="text" name="user" placeholder="Search" title="Enter search keyword">
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-sm-2">
                    <select class="form-select" aria-label="Default select example">
                      ...
                      <option value="1">사용자 계정</option>
                      <option value="2">탈퇴 계정</option>
                    </select>
                  </div>
                </div>
              <!-- end 나이 select --> 
                ...
                <tbody>
                  ...
                  <c:forEach var="lists" items="${lists.content}">
				    <tr>
				      ...
				      <td><c:out value="${lists.nickname}" /></td>
				      <td><c:out value="${lists.tel}" /></td>
				      <td><c:out value="${lists.mail}" /></td>
				      <td><fmt:formatDate value="${lists.date}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
				      <td>
