...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="recommendation-nav" class="nav-content" data-bs-parent="#sidebar-nav">
        <li>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="search-bar" >
                <form class="search-form" method="POST" action="/recommend.do">
                  <b>지역명</b>
                  <input type="text" name="region" placeholder="Search" title="Enter search keyword">
