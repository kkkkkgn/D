<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	String privacyPolicy = "개인정보취급(처리)방침\n\n" +
	    "'Trip Table 주식회사'(이하 '회사'라 합니다)는 이용자의 개인정보를 중요시하며, 「정보통신망 이용촉진 및 정보보호에 관한 법률」, 개인정보보호법」을 준수하기 위하여 노력하고 있습니다.\n\n" +
	    "회사는 개인정보취급(처리)방침을 통하여 회사가 이용자로부터 제공받은 개인정보를 어떠한 용도와 방식으로 이용하고 있으며, 개인정보보호를 위해 어떠한 조치를 취하고 있는지 알려드립니다.\n\n" +
	    "본 방침은 2024년 1월 25일부터 시행되며, 이를 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지하겠습니다.\n\n" +
	    "\n" +
	    "0. 총칙\n" +
	    "\n" +
	    ...
	    "\n" +
	    "회사는 이용자의 개인정보보호를 매우 중요시하며, 「정보통신망 이용촉진 및 정보보호 등에 관한 법률」, 「개인정보보호법」 및 행정안전부가 제정한 '개인정보보호지침' 등을 준수하고 있습니다.\n" +
	    "\n" +
	    "회사는 본 개인정보취급(처리)방침을 통하여 이용자께서 제공하시는 개인정보가 어떠한 용도의 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려 드립니다.\n" +
	    "\n" +
	    "회사는 본 개인정보취급(처리)방침을 G-SRM Supplier Portal 홈페이지(http://www.secbuy.com)의 첫 화면에 공개함으로써 이용자께서 언제나 용이하게 보실 수 있도록 조치하고 있습니다.\n" +
	    "\n" +
	    "회사는 개인정보취급(처리)방침의 지속적인 개선을 위하여 개인정보취급(처리)방침을 개정하는데 필요한 절차를 정하고 있습니다. 그리고 개인정보취급(처리)방침을 개정하는 경우 버전번호 등을 부여하여 개정된 사항을 쉽게 알아볼 수 있도록 하고 있습니다.\n" +
	    "\n" +
	    "1. 수집하는 개인정보의 항목 및 수집방법\n\n" +
	    "(1) 수집하는 개인정보의 항목\n\n" +
	    "회사는 최초 회원 가입 또는 서비스 이용 시 이용자로부터 아래와 같은 개인정보를 수집하고 있습니다.\n\n" +
	    "□ 필수항목\n※ 귀하께서는 필수항목 수집ㆍ이용에 대한 동의를 거부하실 수 있으나, 이는 서비스 제공에 필수적으로 제공되어야 하는 정보이므로, 동의를 거부하실 경우 회원 가입, 서비스 이용, 홈페이지 이용 등을 하실 수 없습니다.\n\n" +
	    "○ 회원가입을 위해 필요한 업체코드, 업체명, 업체명(영문), 로그인ID, 비밀번호, 이름, 영문이름, 위치(국가코드), 언어, 전화번호, E-mail, 승인신청시스템, 2차협력사구분, 2차협력사명\n\n" +
	    "□ 선택항목\n※ 귀하께서는 선택항목 수집ㆍ이용에 대한 동의를 거부하실 수 있으며, 이는 서비스 제공에 필수적으로 제공되어야 하는 정보가 아니므로, 동의를 거부하시더라도 회원 가입, 서비스 이용, 홈페이지 이용 등이 가능합니다. 서비스 이용과정에서 선택항목 수집, 이용이 필요할 경우 별도로 안내하고 동의 받도록 하겠습니다.\n\n" +
	    "○ 휴대폰번호, 팩스번호, 업무\n※ 회사는 이용자의 사생활을 현저히 침해할 우려가 민감정보(사상ㆍ신념, 노동조합ㆍ정당의 가입ㆍ탈퇴, 정치적 견해, 건강, 성생활 등에 관한 정보 등)는 수집하지 않습니다. ※ 회사는 원칙적으로 이용자가 만 14세 미만자일 경우 개인정보를 수집하지 않습니다. 부득이 서비스 이용을 위하여 만 14세 미만자의 개인정보를 수집할 때에는, 사전에 법정대리인의 동의를 구하고 관련 업무가 종료됨과 동시에 정보를 지체 없이 파기토록 하겠으며 업무가 진행되는 동안 개인정보를 철저히 관리토록 하겠습니다.\n\n" +
	    "(2) 개인정보 수집방법\n\n- 홈페이지, 멤버쉽 가입\n※ 회사는 이용자께서 회사의 개인정보 수집ㆍ이용 동의서 각각의 내용에 대해 '동의' 또는 '동의하지 않음'을 선택할 수 있는 절차를 마련하고 있습니다.\n\n" +
	    "2. 개인정보의 수집 및 이용목적\n\n□ 회사는 수집한 개인정보를 다음의 목적을 위해 활용합니다.\n" +
	    "○ 회원관리 및 본인확인\n- 개인정보 처리 및 정보주체의 개인정보 열람, 정정, 삭제 요구시 본인 확인을 위함\n- 삼성전자 구매담당자가 공지사항 및 메일 전송을 하기 위함.\n" +
	    		"3. 개인정보의 보유 및 이용기간\n\n" +
	    	    ...
	    	    "○ 수탁업체의 명칭: 삼성에스디에스㈜ 및 오픈타이드코리아㈜\n" +
	    	    "○ 위탁하는 업무의 내용: 회원관리 서비스 이용에 따른 본인확인, 고지사항 전달, 웹사이트 및 시스템 관리, 문의 등 각종 고객 민원 처리\n\n" +
	    	    "6. 제3자에게의 개인정보 제공\n\n" +
	    	    ...
	    	    "이를 위하여 홈페이지의 “개인정보변경”(또는 “회원정보수정” 등) 메뉴를 이용하시거나, 대표전화(1588-3366) 또는 개인정보 관리책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다.\n\n" +
	    	    ...
	    	    "2. 이용자가 개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인정보를 이용 또는 제3자에게 제공하지 않습니다. 또한 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게 지체 없이 통지하겠습니다.\n\n" +
	    	    "회사는 이용자 혹은 법정대리인의 요청에 의해 삭제/ 처리 정지된 개인정보는 “3. 개인정보의 보유 및 이용기간”에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.\n\n" +
	    	    "이용자의 개인정보를 최신의 상태로 정확하게 입력하여 주시기 바랍니다. 이용자가 입력한 부정확한 정보로 인해 발생\n" +
				...
				"(1) 개인정보 보호를 위한 기술적, 관리적 조치\n\n" +
				 "회사는 이용자의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적, 관리적 조치를 강구하고 있습니다.\n\n"
				+ "- 내부관리계획의 수립 및 시행\n"
				+ "ㆍ회사는 개인정보의 안전한 처리를 위하여 내부관리계획을 수립하고 시행하고 있습니다.\n"
				+ "ㆍ회사는 사내 개인정보보호 전담기구 등을 통해 개인정보보호조치의 이행사항 및 담당자의 준수여부를 확인하여 문제 발견 시 즉시 시정 조치하도록 하고 있습니다.\n\n"
				+ "- 접근통제장치의 설치 및 운영\n"
				+ "ㆍ회사는 침입차단시스템을 이용하여 외부로부터 무단 접근을 통제하고 있으며, 기타 시스템적으로 보안성을 확보하기 위하여 가능한 모든 기술적 장치를 갖추려 노력하고 있습니다.\n\n"
				+ "- 접속기록의 위조, 변조 방지를 위한 조치\n"
				+ "ㆍ회사는 개인정보처리시스템에 접속한 기록을 보관, 관리하고 있으며, 접속기록이 위조, 변조되지 않도록 보안기능을 사용하고 있습니다.\n\n"
				+ "- 개인정보의 암호화\n"
				+ "ㆍ이용자의 개인정보는 비밀번호에 의해 보호되며, 파일 및 전송 데이터를 암호화하거나 파일 잠금기능(Lock)을 사용하여 저장, 관리되며, 중요한 데이터는 별도의 보안기능을 통해 보호되고 있습니다.\n\n"
				+ "- 해킹 등에 대비한 대책\n"
				+ "ㆍ회사는 백신프로그램을 이용하여 컴퓨터바이러스에 의한 피해를 방지하기 위한 조치를 취하고 있습니다. 백신프로그램은 주기적으로 업데이트되며 갑작스런 바이러스가 출현할 경우 백신이 나오는 즉시 이를 제공함으로써 개인 정보가 침해되는 것을 방지하고 있습니다.\n"
				+ "ㆍ회사는 암호알고리즘을 이용하여 네트워크 상의 개인정보를 안전하게 전송할 수 있는 보안장치(SSL)를 채택하고 있습니다.\n"
				+ "ㆍ해킹 등 외부침입에 대비하여 각 서버마다 침입차단시스템 및 취약점 분석 시스템 등을 이용하여 보안에 만전을 기하고 있습니다.\n"
				+ "ㆍ개인정보와 일반 데이터를 혼합하여 보관하지 않고 별도의 서버를 통해 분리하여 보관하고 있습니다.\n\n"
				+ "- 취급 직원의 최소화 및 교육\n"
				+ "ㆍ회사는 이용자의 개인정보에 대한 접근권한을 이용자를 직접 상대로 하여 마케팅 업무를 수행하는 자, 개인정보관리책임자 및 담당자 등 개인정보관리업무를 수행하는 자, 기타 업무상 개인정보의 취급이 불가피한 자로 제한 하고 있습니다.\n"
				+ "ㆍ개인정보를 취급하는 직원을 대상으로 새로운 보안 기술 습득 및 개인정보 보호 의무 등에 관해 정기적인 사내 교육 및 외부 위탁교육을 실시하고 있습니다.\n"
				+ "ㆍ입사시 전 직원의 보안서약서를 통하여 사람에 의한 정보유출을 사전에 방지하고 개인정보보호정책에 대한 이행사항 및 직원의 준수여부를 감사하기 위한 내부절차를 마련하고 있습니다.\n"
				+ "ㆍ개인정보 관련 취급자의 업무 인수인계는 보안이 유지된 상태에서 철저하게 이뤄지고 있으며 입사 및 퇴사후 개인정보 사고에 대한 책임을 명확화하고 있습니다.\n"
				+ "ㆍ전산실 및 자료 보관실 등을 특별 보호구역으로 설정하여 출입을 통제하고 있습니다.\n\n"
				+ "(2) 링크사이트 제공 방침\n\n"
				+"회사는 이용자에게 다른 회사의 웹사이트 또는 자료에 대한 링크를 제공할 수 있으며, 삼성서비스를 통해 제3자가 개발한 제품 및 서비스를 사용할 수 있습니다(예를 들어, 삼성앱스를 통해 제3자가 개발한 어플리케이션을 다운로드 받아 사용하는 경우 등).\n"
				...
				+ "팩스ㆍ휴대폰 문자전송 등 이메일 이외의 매체를 통해 영리목적의 광고성 정보를 전송하는 경우 관련 법령에 따라 전송내용 처음에 “광고” 문구를 표기하는 등 필요한 조치를 행합니다."
				+ "10. 개인정보 관리책임자 및 고객서비스 담당부서 등 안내\n\n"
			...
			<div class="w-100">
				...
				<div class="card mt-3" id="userLogin">
					<div class="container" style="margin-top: 17px" width="400px">
						<div class="container" style="margin: auto; height:300px width: 388px; text-align: center">
							<h3>TripTable을 바로 시작해보세요</h3>
							<div class="mb-3 mt-4">
									...
									<div class="form-group">
										<form action="./joinForm.do">
											<div style="width: 400px">
													...
													<textarea class="form-control" rows="4" style="height:170px"><%=privacyPolicy %></textarea>

												<div class="form-group form-check flex flex-col" style="text-align:left;">
													<label class="form-check-label my-3"> <input
														class="form-check-input" type="checkbox" name="remember"
														required> [필수] TripTable 서비스 이용 약관
													</label>
<!-- 													<label class="form-check-label"> <input -->
<!-- 														class="form-check-input" type="checkbox" name="remember" -->
<!-- 														required> [선택] TripTable의 광고 메시지를 메일로 받기 -->
<!-- 													</label> -->
												</div>
											</div>
											<br />
