...
<body class="flex gap-4 mt-3" style="box-sizing: border-box; flex-wrap: wrap; width: 1000px; margin: auto;">
    <form id="frm" name="frm" action="testmapWrite.jsp" method="post">
        <div id="wrapper">
            <div class="map_wrap" >
    ...
    <script>
        ...
        // 검색 결과 목록이나 마커를 클릭했을때 장소명을 표출할 인포윈도우를 생성;
        ...
        loadEl = places.place_name + places.road_address_name + places.address_name + places.phone;
        console.log(loadEl);
    ...
    <div>
        <div id="mapData" style="width: 170px; z-index: 11; position: fixed; top: 145px; right: 0;">
            ...
            <label>이름 : </label>
            <input style="display: inline-block;" type="text" id="pname" name="pname" value="" />
            <label>주소 : </label>
            <input style="display: inline-block;" type="text" id="paddress" name="paddress" value="" />
            <label>위도 : </label>
