    ...
    <header class="common-layout-react-HeaderV2 fv-6 fv-6-header--fixed fv-6-header--fixed--desktop" style="height:80px">
                    ...
                    <div class="iiio-fields iiio-mod-animate-width" role="search" style="width: 625.234px;">
                        <div class="iiio-mod-display-extended iiio-animate-end" style="visibility: visible;">
                            <div class="lfBz-field-outline lfBz-mod-presentation-extended">
                                <div role="button" idtabindex="0" class="NITa NITa-location NITa-hasValue NITa-mod-presentation-expanded" aria-label="목적지">
                            ...
                            <!-- <div class="ui-layout-header-HeaderTripsItem">
                                <div class="trips-drawer-wrapper theme-dark show-separator">
                                    <button class="trips-drawer-trigger" aria-label="트립 드로어 열기">
                                        <svg viewBox="0 0 200 200" width="1.25em" height="1.25em" xmlns="http://www.w3.org/2000/svg" class="drawer-trigger-icon" role="img" aria-hidden="true" style=" vertical-align: baseline;">
                                            <path d="M145.5 20c-23.6-1-38.6 15.3-45.5 25.3C93.1 35.3 78.1 19 54.5 20C30 21.1 10 41.8 10 66c0 19.3 11.1 41.1 32.9 64.9c17.1 18.8 33.2 34.2 47.8 45.7c5.5 4.4 13.1 4.3 18.6 0c14.4-11.3 30.1-26.3 47.8-45.7c21.8-23.9 32.9-45.7 32.9-65c0-24.1-20-44.8-44.5-45.9z"></path>
                                        </svg>
                                    </button>
                                </div>
                            </div> -->
                                                ...
                                                <div class="common-layout-react-HeaderAccountBadge">
                                                    <div class="account-label">
                                                        <div class="account-label__inner">
                                                            <span class="account-name inspectlet-sensitive" dir="auto"> ${user.name}</span> 님
        ...
        <div class="c5ab7 c5ab7-collapsed">
            <div role="dialog" style="height: 100vh;">
                <div tabindex="-1" class="pRB0 pRB0-collapsed pRB0-mod-variant-accordion pRB0-mod-position-fixed" style="top:80px; height:calc(100% - 80px);">
                    <div>
                        <div class="pRB0-nav-items">
                            <nav class="HtHs" aria-label="홈">
                                <ul class="HtHs-nav-list">
                                    ...
                                    <!-- user 변수가 세션에 존재하는 경우 -->
                                        <li>
                                            <a href="./trip_plan.do" aria-label="여행 계획" class="dJtn dJtn-collapsed dJtn-mod-variant-drawer" aria-current="false" tabindex="-1">
                                    ...
                                    <!-- user 변수가 세션에 존재하는 경우 -->
                                        <li>
                                            <a href="./acc_reservation.do" aria-label="숙소 예약" class="dJtn dJtn-collapsed dJtn-mod-variant-drawer" aria-current="page" tabindex="0">
                                                <svg viewBox="0 0 200 200" width="1.25em" height="1.25em" xmlns="http://www.w3.org/2000/svg" class="dJtn-menu-item-icon" role="img" aria-hidden="true">
                                                    <path d="M175 170a5 5 0 0 1-5-5v-5H30v5a5 5 0 1 1-10 0v-43.092c0-8.176 3.859-15.462 10-20.027V65c0-13.785 11.215-25 25-25h90c13.785 0 25 11.215 25 25v36.98c6.093 4.613 10 11.922 10 19.928V165a5 5 0 0 1-5 5zM30 150h140v-10H30v10zm0-20h140v-8.092c0-7.342-5.486-13.707-12.762-14.806c-40.216-6.077-73.399-6.207-114.477 0C35.415 108.21 30 114.4 30 121.908V130zm120-34.027c2.877.382 9.581 1.381 10 1.467V65c0-8.271-6.729-15-15-15H55c-8.271 0-15 6.729-15 15v32.438c.418-.084 7.123-1.083 10-1.465V85c0-8.271 6.729-15 15-15h25a14.94 14.94 0 0 1 10 3.829A14.943 14.943 0 0 1 110 70h25c8.271 0 15 6.729 15 15v10.973zm-45-3.45c11.463.167 22.988.912 35 2.233V85c0-2.757-2.243-5-5-5h-25c-2.757 0-5 2.243-5 5v7.523zM65 80c-2.757 0-5 2.243-5 5v9.756c12.012-1.321 23.537-2.065 35-2.232V85c0-2.757-2.243-5-5-5H65z"></path>
                                                </svg>
                                    ...
                                    <li>
                                        <a href="./mypage.do" aria-label="타임머신 " class="dJtn dJtn-collapsed dJtn-mod-variant-drawer" aria-current="false" tabindex="-1">
                                            <svg viewBox="0 0 200 200" width="1.25em" height="1.25em" xmlns="http://www.w3.org/2000/svg" class="dJtn-menu-item-icon" role="img" aria-hidden="true">
                                    ...
                                    <!-- user 변수가 세션에 존재하는 경우 -->
                                        <li>
                                            <a href="./course2.do" aria-label="코스 추천" class="dJtn dJtn-collapsed dJtn-mod-variant-drawer" aria-current="false" tabindex="-1">
                                                <svg viewBox="0 0 200 200" width="1.25em" height="1.25em" xmlns="http://www.w3.org/2000/svg" class="dJtn-menu-item-icon" role="img" aria-hidden="true">
                        ...
                        <div class="pRB0-nav-items">
                            <div>
                                <a href="./about.do" aria-label="이용 안내" class="dJtn dJtn-collapsed dJtn-mod-variant-drawer" aria-current="false" tabindex="-1">
                                    <svg viewBox="0 0 200 200" width="1.25em" height="1.25em" xmlns="http://www.w3.org/2000/svg" class="dJtn-menu-item-icon" role="img" aria-hidden="true">
        ...
        <div class="xvRy xvRy-mod-radius-default xvRy-mod-animated xvRy-visible" style="width: 250px; height: 173px;">
            ...
            <div class="xvRy-content">
                <div class="c4Nhy c4Nhy-mod-dropdown">
                    <!-- <a class="XeSA" href="./mypage.do" aria-labelledby="trips-menu-item-label" role="menuitem" tabindex="0">
                        <div id="trips-menu-item-label" class="XeSA-item-label">타임머신</div>
                    </a> -->
                    ...
                    <a class="XeSA" href="./mypage.do" aria-labelledby="account-menu-item-label" role="menuitem" tabindex="0">
                	...
                	<div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    	...
                    	<div class="carousel-inner">
                        	<div class="carousel-item active" data-bs-interval="4000">
                            	<img src="../img/image1.png" alt="Los Angeles" class="d-block" style="width: 100%">
                        	</div>
                        	<div class="carousel-item" data-bs-interval="4000">
                            	<img src="../img/image2.png" alt="Chicago" class="d-block" style="width: 100%">
                        	</div>
                        	<div class="carousel-item" data-bs-interval="4000">
								<img src="../img/image3.png" alt="New York" class="d-block" style="width: 100%">
							</div>
                        	<!-- 추가 이미지 -->
                    	</div>
